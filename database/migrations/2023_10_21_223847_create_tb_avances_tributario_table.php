...
class CreateTbAvancesTributarioTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tb_avances_tributario', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tb_avances_tributario');
    }
}
